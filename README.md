...
### 💡 یافته‌های کلیدی پروژه (پاسخ به سوالات تحلیل) / Key Insights

**۱. نوسانات درون‌روزی (ساعت طلایی بازار):**
تحلیل میانگین نوسانات نشان می‌دهد که بیشترین میزان حرکت قیمت و تغییرات شارپ در بازه زمانی هم‌پوشانی بازار لندن و نیویورک اتفاق می‌افتد و این ساعات بالاترین پتانسیل را برای استراتژی‌های اسکالپ دارند.

**۲. رفتار بازار در آخر هفته (Weekend Volume):**
طبق نمودار مقایسه‌ای روزهای هفته، حجم معاملات در برخی روز ها به شدت افت می‌کند که نشان‌دهنده ریسک بالای ترید در این روزها به دلیل احتمال حرکت‌های فیک است.

**۳. روند کلی و بیشترین/کمترین قیمت (برای بررسی کلی در یک دید)**
۲ نمودار دیگه برای دید کلی نسبت به ارز هست. ۱. روند کلی قیمت در بازه هفاگی ۲.مقایسه سقف و کف قیمت در ۲ تاریخ مختلف. 
